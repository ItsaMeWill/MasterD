...
namespace InventorySystem
{
    ...
    public class ConsoleTable
    {
        ...
        public void Write(Format format = InventorySystem.Format.Default)
        {

            switch (format)
            {
                case InventorySystem.Format.Default:
                    Options.OutputTo.WriteLine(ToString());
                    break;
                case InventorySystem.Format.MarkDown:
                    Options.OutputTo.WriteLine(ToMarkDownString());
                    break;
                case InventorySystem.Format.Alternative:
                    Options.OutputTo.WriteLine(ToStringAlternative());
                    break;
                case InventorySystem.Format.Minimal:
